...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    for policy_name in inline_policy_names:
        ...
        if is_statements_include_full_star_allow(policy_document['Statement']):
            return build_evaluation_from_config_item(configuration_item, "NON_COMPLIANT",policy_arn = " ", annotation='The inline policy "' + policy_name + '" attached to the user "' + user_name + '" has full star allow permissions.')
    ...
    for policy_arn, policy_name in managed_policy_arn_and_name.items():
        ...
        if is_statements_include_full_star_allow(get_policy_version['PolicyVersion']['Document']['Statement']):
            return build_evaluation_from_config_item(configuration_item, "NON_COMPLIANT",policy_arn, annotation='The managed policy "' + policy_name + '" attached to the user "' + user_name + '" has full star allow permissions.')
...
def build_evaluation_from_config_item(configuration_item, compliance_type,policy_arn = " ", annotation=None):   
    ...
    if annotation:
        ...
        eval_ci['ComplianceResourceId'] = configuration_item['resourceId'] + '###' + policy_arn
